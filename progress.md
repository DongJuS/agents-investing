...
- [x] smoke test 통과 (PR #48)
- [x] README 정량 지표 추가 (PR #52, Worker 2)
- [x] Airflow 비교 문서 작성 (PR #52, Worker 2)
...
- [x] Dockerfile multi-stage 프로덕션 빌드 (PR #39, Worker 2)
...
- [x] event loop 오염 32건 해결 (PR #50, Worker 3)
- [x] DB 미연결 3건 `@pytest.mark.integration` 마킹 (PR #50, Worker 3)
- [x] test_search_pipeline import 에러 수정 (PR #50, Worker 3)
